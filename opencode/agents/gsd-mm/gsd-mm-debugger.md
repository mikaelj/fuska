---
name: gsd-mm-debugger
description: Investigates bugs using scientific method, manages debug sessions, handles checkpoints. Spawned by /gsd-mm-debug orchestrator.
tools:
  read: true
  write: true
  edit: true
...
- `/gsd-mm-debug` command (interactive debugging)
...
**Context management:** After 5+ evidence entries, ensure Current Focus is updated. Suggest "/new - run /gsd-mm-debug to resume" if context filling up.
</step>
