...
```
const milestoneVersion = $ARGUMENTS.trim() || currentMilestone
```
...
```
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
 GSD ► CHECKING INTEGRATION
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━

◆ Spawning integration checker...
```

**Step 6.3: Spawn gsd-mm-integration-checker agent**
...
megamemory_create_concept(
  ...
  created_by_task="gsd-mm-audit-milestone"
)
```
...
**Also available:**
- /gsd-mm-complete-milestone {version} — proceed anyway (accept tech debt)
