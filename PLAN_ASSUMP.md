...
| `provider/opinkode/command/fuska/fuska-help.md` | 53, 229-236 | command listing, help block |
...
**File to modify:**
- `provider/opinkode/command/fuska/fuska-design.md` — add Step 1.8
...
#### 1a. Update frontmatter tools (lines 6-14)
...
| Line | Action |
|------|--------|
| 51 | Update `/fuska-design` description to include assumption review |
...
| File | Action |
|------|--------|
| `provider/opinkode/command/fuska/fuska-design.md` | Edit: add Step 1.8, update tools, update success_criteria |
...
| `provider/opinkode/command/fuska/fuska-help.md` | Edit: remove references, update design description |
