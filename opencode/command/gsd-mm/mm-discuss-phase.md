...
if (!phaseNumber) {
  ...
  Display: "Usage: /gsd-mm-discuss-phase <phase>"
  Stop
}
```
...
→ Suggest: `/gsd-mm-plan-phase ${phaseNumber} --research`
...
→ Suggest: `/gsd-mm-plan-phase ${phaseNumber}`
...
/gsd-mm-plan-phase ${phaseNumber} --research

**Or skip to planning:**

**Plan Phase ${phaseNumber}** — create execution plans directly
/gsd-mm-plan-phase ${phaseNumber}
