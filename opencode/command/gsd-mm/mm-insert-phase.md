...
Example: `/gsd-mm-insert-phase 72 Fix critical auth bug`
→ after = 72
...
if [ $# -lt 2 ]; then
  ...
  echo "Usage: /gsd-mm-insert-phase <after> <description>"
  echo "Example: /gsd-mm-insert-phase 72 Fix critical auth bug"
  exit 1
fi
```
...
`/gsd-mm-plan-phase {decimal_phase}`
...
- Don't use this for planned work at end of milestone (use /gsd-mm-add-phase)
