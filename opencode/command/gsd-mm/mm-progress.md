...
${pendingTodos > 0 ? `## Pending Todos\n- ${pendingTodos} pending — /gsd-mm-check-todos to review` : ''}

${activeDebugSessions > 0 ? `## Active Debug Sessions\n- ${activeDebugSessions} active — /gsd-mm-debug to continue` : ''}
...
/gsd-mm-execute-phase ${currentPhaseNumber}
...
/gsd-mm-plan-phase ${currentPhaseNumber}
...
/gsd-mm-discuss-phase ${currentPhaseNumber} — gather context and clarify approach
...
**Also available:**
- /gsd-mm-plan-phase ${currentPhaseNumber} — skip discussion, plan directly
────────────────────────────────────────────────────────────
```
...
/gsd-mm-plan-phase ${currentPhaseNumber} --gaps
...
**Also available:**
- /gsd-mm-execute-phase ${currentPhaseNumber} — execute phase plans
- /gsd-mm-verify-work ${currentPhaseNumber} — run more UAT testing
────────────────────────────────────────────────────────────
```
...
/gsd-mm-discuss-phase ${nextPhase.number} — gather context and clarify approach
...
**Also available:**
- /gsd-mm-plan-phase ${nextPhase.number} — skip discussion, plan directly
- /gsd-mm-verify-work ${currentPhaseNumber} — user acceptance test before continuing
────────────────────────────────────────────────────────────
```
...
**Also available:**
- /gsd-mm-verify-work — user acceptance test before completing milestone
────────────────────────────────────────────────────────────
```
...
- Phase complete but next phase not planned → offer `/gsd-mm-plan-phase [next]`
- All work complete → offer milestone completion
- Blockers present → highlight before offering to continue
- Handoff checkpoint exists → mention it, offer `/gsd-mm-resume-work`
...
- [ ] Smart routing: /gsd-mm-execute-phase if plans exist, /gsd-mm-plan-phase if not
- [ ] User confirms before any action
- [ ] Seamless handoff to appropriate gsd-mm command
