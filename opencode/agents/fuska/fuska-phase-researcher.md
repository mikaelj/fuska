...
- `/fuska-plan-phase` orchestrator (integrated research before planning)
- `/fuska-research-phase` orchestrator (standalone research)
...
<upstream_input>
**CONTEXT.md** (if exists) — User decisions from `/fuska-discuss-phase`
...
<downstream_consumer>
Your research concept is consumed by `fuska-planner` via MegaMemory query which uses specific sections:
