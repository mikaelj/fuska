...
→ Suggest: "/gsd-mm-new-project to start a new project"
→ Stop
...
→ Suggest: "Reinitialize with /gsd-mm-new-project or select different project"
→ Stop
...
1. Discuss phase first — Gather context, clarify approach
   /gsd-mm-discuss-phase {currentPhase}

2. Plan directly — Skip discussion, create plans
   /gsd-mm-plan-phase {currentPhase}
```
...
1. Execute phase — Run all plans for this phase
   /gsd-mm-execute-phase {currentPhase}
...
2. Verify work — Manual acceptance testing
   /gsd-mm-verify-work {currentPhase}
...
1. Next phase — Move to next phase in roadmap
   /gsd-mm-discuss-phase {next_phase}
...
- /gsd-progress — View detailed project progress
- /gsd-mm-discuss-phase {N} — Discuss a phase
- /gsd-mm-plan-phase {N} — Plan a phase
- /gsd-mm-execute-phase {N} — Execute a phase
- /gsd-mm-verify-work {N} — Verify work
