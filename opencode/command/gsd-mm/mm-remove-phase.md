...
- Example: `/gsd-mm-remove-phase 17` → phase = 17
- Example: `/gsd-mm-remove-phase 16.1` → phase = 16.1

If no argument provided:

```
ERROR: Phase number required
Usage: /gsd-mm-remove-phase <phase-number>
Example: /gsd-mm-remove-phase 17
```
...
```
const phaseNumber = parseFloat($ARGUMENTS)
...
To abandon current work, use /gsd-mm-pause-work instead.
```
...
Would you like to:
- /gsd-mm-progress — see updated roadmap status
