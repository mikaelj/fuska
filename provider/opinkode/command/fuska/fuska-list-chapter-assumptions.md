...
```json
{ "matches": [ { "id": "chapter-01", "name": "chapter-01", "kind": "feature", "summary": "{\"name\":\"Foundation\",\"goal\":\"...\",\"status\":\"pending\"}", "children": [...], "edges": [...] } ] }
```
...
→ Ask if they want to design chapter first: `/fuska-design-chapter {X}`
→ Re-prompt for feedback
