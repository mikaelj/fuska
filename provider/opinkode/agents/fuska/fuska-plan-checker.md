...
**The difference:**
- `fuska-verifier`: Verifies code DID achieve goal (after execution)
- `fuska-plan-checker`: Verifies plans WILL achieve goal (before execution)
...
**DO NOT check code existence.** That's fuska-verifier's job after execution. You verify plans, not codebase.
