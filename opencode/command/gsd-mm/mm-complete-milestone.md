---
name: gsd-mm-complete-milestone
...
Suggest: "Run /gsd-audit-milestone first" → Stop
...
Suggest: "Run /gsd-plan-milestone-gaps first" or offer "Proceed anyway" option
...
```
**Also available:**
- /gsd-mm-progress — View detailed project progress
- /gsd-mm-verify-work — Verify work before starting next milestone
────────────────────────────────────────────────────────────
```
...
- Audit missing → recommend /gsd-audit-milestone
- Audit has gaps → recommend /gsd-plan-milestone-gaps or offer to proceed as tech debt
...
- **Fresh requirements:** Next milestone starts with /gsd-mm-new-milestone which includes requirements definition
