...
**ROADMAP Concept Data Structure:**

Store roadmap data in MegaMemory as a concept with kind="config".

**JSON Schema for ROADMAP concept.summary:**
```json
{
  "phases": [
    {
      ...
      "plans_complete": 3,
      "plans_total": 3,
      "description": "Phase goal description"
    },
    {
      "number": 2,
      "name": "Authentication",
...
**STATE Concept Data Structure:**

Store project state in MegaMemory as a concept with kind="config".

**JSON Schema for STATE concept.summary:**
```json
{
  "current_position": {
    "phase": 3,
  ...
  "project_reference": {
    ...
    "core_value": "Current core value from PROJECT",
...
**PROJECT Concept Data Structure:**

Store project info in MegaMemory as a concept with kind="module".

**JSON Schema for PROJECT concept.summary:**
```json
{
  "what_this_is": "Brief product description",
...
```bash
# Get STATE concept
megamemory:understand(query="project state current position")

# Get ROADMAP concept
megamemory:understand(query="roadmap phases progress")

# Get PROJECT concept
megamemory:understand(query="project requirements decisions")

# Parse JSON from concept.summary
echo "$CONCEPT_SUMMARY" | jq '.key'
```
