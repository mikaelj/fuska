...
await megamemory.createConcept({
  name: "Stage Banner",
  kind: "pattern",
  summary: "Major workflow transition display with GSD ► prefix, 62-char width",
  ...
  edges: [
    ...
    },
    {
      to: "gsd-prefix",
      relation: "configured_by",
      description: "Always uses GSD ► prefix"
    }
  ]
});
...
await megamemory.createConcept({
  ...
  kind: "pattern",
  summary: "Stage banner for questioning phase: 'GSD ► QUESTIONING'",
