...
Usage: /fuska-list-phase-assumptions [phase-number]
...
```
What's next?
1. Discuss context (/fuska-discuss-phase ${PHASE}) - Let me ask you questions to build comprehensive context
2. Plan this phase (/fuska-plan-phase ${PHASE}) - Create detailed execution plans
