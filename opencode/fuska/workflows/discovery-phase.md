...
NOTE: For comprehensive ecosystem research ("how do experts build this"), use /fuska-research-phase instead, which creates a RESEARCH concept.
</purpose>
...
1. Discuss phase context (/fuska-discuss-phase [current-phase])
2. Create phase plan (/fuska-plan-phase [current-phase])
