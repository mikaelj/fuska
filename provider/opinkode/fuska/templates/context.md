...
## Example 1: Creating Post Feed Context
...
## Example 2: Querying Decisions by Area
...
// Result includes:
// "Loading behavior: Infinite scroll, not pagination; Pull-to-refresh on mobile; New posts indicator at top"
// Planner creates task: "Implement infinite scroll with virtualization"
```

## Example 3: Researcher Context Query
...
// Research focuses on: card-based layout, shadows, rounded corners
// Searches Context7 for: React card components, shadow utilities
```
