...
**After this command:** Run `/gsd-mm-plan-phase [N]` to start execution.
</objective>
...
Spawn 4 parallel gsd-mm-phase-researcher agents with milestone-aware context:
...
megamemory_create_concept(
  ...
  created_by_task="gsd-mm-new-milestone"
)
```
...
Spawn gsd-mm-planner agent with context:
...
**Also available:**
- /gsd-mm-plan-phase [N] — skip discussion, plan directly
...
megamemory_remove_concept(
  ...
  reason="Consumed by gsd-mm-new-milestone"
)
```
