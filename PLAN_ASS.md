...
**Files to delete:**
- `provider/opinkode/commands/fuska/fuska-list-chapter-assumptions.md` — exists ✅
- `provider/opinkode/fuska/workflows/list-chapter-assumptions.md` — exists ✅

**Files with references to remove:**
| File | Lines | Content |
|------|-------|---------|
| `provider/opinkode/commands/fuska/fuska.md` | 309, 376 | dispatch row, verb in list |
| `provider/opinkode/commands/fuska/fuska-help.md` | 51, 53, 229-236 | design description, command listing, help block |
...
**File to modify:**
- `provider/opinkode/commands/fuska/fuska-design.md` — add Step 1.8, update success_criteria

---

## Execution Steps

### 1. Modify `provider/opinkode/commands/fuska/fuska-design.md`
...
### 2. Delete `provider/opinkode/commands/fuska/fuska-list-chapter-assumptions.md`
...
### 4. Update `provider/opinkode/commands/fuska/fuska.md`
...
### 5. Update `provider/opinkode/commands/fuska/fuska-help.md`
...
| File | Action |
|------|--------|
| `provider/opinkode/commands/fuska/fuska-design.md` | Edit: add Step 1.8, update success_criteria |
| `provider/opinkode/commands/fuska/fuska-list-chapter-assumptions.md` | **Delete** |
| `provider/opinkode/fuska/workflows/list-chapter-assumptions.md` | **Delete** |
| `provider/opinkode/commands/fuska/fuska.md` | Edit: remove dispatch row and verb |
| `provider/opinkode/commands/fuska/fuska-help.md` | Edit: update design description, remove references |
