---
name: fuska-research-phase
description: Research how to implement a phase (standalone - usually use /fuska-plan-phase instead) using MegaMemory
argument-hint: "[phase]"
agent: @../../agents/fuska/fuska-phase-researcher.md
tools:
  - read
  - bash
  - webfetch
...
<objective>
Research how to implement a phase using MegaMemory. Spawns fuska-phase-researcher agent with phase context.

**Note:** This is a standalone research command. For most workflows, use `/fuska-plan-phase` which integrates research automatically.
...
## 4. Spawn fuska-phase-researcher Agent
...
<downstream_consumer>
Your research concept will be loaded by `/fuska-plan-phase` which uses specific sections:
...
- [ ] fuska-phase-researcher spawned with context
