---
name: gsd-mm-list-phase-assumptions
...
→ Example: `/gsd-mm-list-phase-assumptions 3`
→ Stop
...
→ Ask if they want to discuss phase first: `/gsd-mm-discuss-phase {X}`
→ Re-prompt for feedback
