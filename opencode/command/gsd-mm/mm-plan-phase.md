...
**Orchestrator role:** Parse arguments, validate phase, research domain (unless skipped or exists), spawn gsd-mm-planner agent, verify plans with gsd-mm-plan-checker, iterate until plans pass or max iterations reached, present results.
...
Parse the argument string to identify:
```
const hasResearchFlag = $ARGUMENTS.includes("--research")
const hasSkipResearchFlag = $ARGUMENTS.includes("--skip-research")
...
```
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
 GSD ► RESEARCHING PHASE ${phaseNumber}
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━

 ◆ Spawning researcher...
```

### Spawn gsd-mm-phase-researcher
...
<downstream_consumer>
Output consumed by /gsd-mm-execute-phase
...
## 10. Spawn gsd-mm-plan-checker Agent
...
**Step 10.2: Build checker prompt**

Use the data extracted in step 9 (planConcepts and requirementConcepts) and phaseData from step 3:
...
**Step 10.3: Spawn checker**

```
Task(
  description="Verify Phase ${phaseNumber} plans",
...
**Plans to verify:**
Include all plan concept summaries here — each plan's JSON with wave, depends_on, files_modified, autonomous, objective, tasks, and must_haves.

**Requirements (if exists):**
Include all requirement concept summaries here (each with description and status). Omit if no requirements were found.
</verification_context>
...
- /gsd-mm-plan-phase {X} --research — re-research first
──────────────────────────────────────────────────────────────
```
...
- [ ] gsd-mm-planner spawned with MegaMemory context
- [ ] Plan concepts created (PLANNING COMPLETE or CHECKPOINT handled)
- [ ] gsd-mm-plan-checker spawned (unless --skip-verify)
